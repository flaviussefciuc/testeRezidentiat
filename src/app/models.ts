...
export interface Question { id: string; topicId: string; type: 'CS' | 'CM'; stem: string; options: string[]; correct: number[]; explanation: string; source: string; difficulty?:{score:number;kind:'editorial-estimate';reason:string}; }

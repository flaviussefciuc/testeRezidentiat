...
export const SOURCE_CHECKED_QUESTIONS:Question[]=[...SEPSIS_SOURCE];
...
export const QUESTIONS:Question[]=[...LEGACY_QUESTIONS.filter(q=>q.topicId!=='sepsis'),...SOURCE_CHECKED_QUESTIONS];

...
q('hemostaza-adv-006',['Referitor la triada letală a pacientului traumatizat:',
 ['hipotermia este definită de o temperatură centrală <35°C','acidoza este definită de un pH <7,20','hipotermia este prezentă la 50% dintre pacienți la prezentare','hipotermia exclude prezența unor semne vitale normale','hipotermia inhibă factorii de coagulare'],'ACE',44,'Tulburări metabolice — Triada letală',
 'Fixarea definițiilor componentelor triadei letale și a efectelor hipotermiei.',
 ['Hipotermia este definită ca temperatură centrală <35°C.','Acidoza este definită prin pH <7,35.','Hipotermia este observată la 50% dintre pacienții cu traumatisme la prezentare.','Hipotermia poate fi prezentă la un pacient cu semne vitale normale.','Hipotermia alterează funcția trombocitară și inhibă factorii de coagulare.']],
...
q('hemostaza-adv-015',['Reacțiile febrile transfuzionale:',
 ['sunt cele mai frecvente reacții imunologice de transfuzie','apar de obicei prin anticorpi antileucocitari','impun continuarea transfuziei sub antipiretice','pot fi prevenite prin masă eritrocitară deleucocitată','apar de obicei prin incompatibilitate ABO'],'ABD',44,'Reacții imunologice de transfuzie — Reacțiile febrile',
 'Recunoașterea frecvenței, mecanismului și conduitei în reacțiile febrile.',
 ['Reacțiile febrile sunt cele mai frecvente reacții imunologice de transfuzie.','Ele apar de obicei ca urmare a anticorpilor antileucocitari.','Transfuzia trebuie oprită; antipireticele se dau preventiv, înaintea transfuziei.','Transfuzia cu masă eritrocitară deleucocitată poate fi eficientă preventiv.','Incompatibilitatea ABO este mecanismul reacției hemolitice acute.']],
...
q('hemostaza-adv-021',['La pacienții cu afecțiuni hepatice sau renale, conform capitolului:',
 ['transaminazele sunt utile pentru aprecierea coagulopatiei','INR monitorizează funcția de sinteză hepatică','hemoragia și hipercoagulabilitatea pot coexista','dializa elimină complet riscul hemoragic uremic','dializa crește riscul de evenimente trombotice'],'BCE',43,'Cazuri particulare — Afecțiuni hepatice și renale',
...
q('hemostaza-adv-025',['Agenții hemostatici locali utilizați intraoperator includ:',
 ['fondaparina (Arixtra)','celuloza oxidată (Surgicel)','colagenul microfibrilar (Avitene)','acidul ε-aminocaproic topic','bivalirudina (Angiomax)'],'BCD',40,'Complicații intraoperatorii — Agenți hemostatici locali',
...
q('hemostaza-adv-027',['Hemoragia postoperatorie:',
 ['după hepatectomie extinsă se corectează de obicei în 24 de ore','se datorează în 50% din cazuri hemostazei intraoperatorii deficitare','poate fi produsă de heparina reziduală după bypass cardiopulmonar','prin deficit de factor XIII apare în primele 30 de minute','poate apărea prin deficit de factori K-dependenți la malnutriți'],'BCE',41,'Hemoragii postoperatorii',
...
q('hemostaza-adv-031',['Reacția hemolitică acută transfuzională:',
 ['poate debuta după administrarea a doar 50 mL de sânge','se previne prin iradierea eritrocitelor','se datorează cel mai frecvent unei erori de identificare ABO','impune oprirea imediată a transfuziei','contraindică administrarea de manitol sau furosemid'],'ACD',45,'Reacții imunologice — Reacția hemolitică acută',

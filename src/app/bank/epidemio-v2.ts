...
q('epidemio-adv-002',['Studiile de cohortă:',
 ['permit calcularea riscului relativ','pot fi prospective sau retrospective','sunt consumatoare de timp și resurse','se potrivesc bine bolilor rare','evaluează un număr mare de persoane la un singur moment'],'ABC',333,'Tabelul 15-1',
 'Recunoașterea caracteristicilor studiilor de cohortă.',
 ['Concluzia lor este riscul relativ.','Pot fi prospective sau retrospective.','Sunt consumatoare de resurse financiare și de timp.','Bolile rare sunt dificil de studiat.','Descrie studiul transversal.']],
 [8,'Distractorii preiau trăsături ale altor studii.'],['Risc relativ','prospective']),

q('epidemio-adv-013',['Trialul clinic randomizat:',
 ['compară prospectiv tratamentul cu placebo și terapiile existente','alocă randomizat pacienții','este standardul de aur pentru testarea medicamentelor','permite estimarea prevalenței după expunere','nu poate controla factorii de confuzie'],'ABC',333,'Tabelul 15-1',
 'Recunoașterea caracteristicilor trialului clinic randomizat.',
 ['Compară prospectiv cu placebo și terapiile existente.','Alocarea este randomizată, dublu-orb.','Este standardul de aur pentru testarea medicamentelor.','Descrie studiul transversal.','Poate fi controlat pentru mai mulți factori de confuzie.']],
...
q('epidemio-adv-012',['Ratele de morbiditate:',
 ['incidența raportează cazurile noi la populația la risc','prevalența raportează cazurile existente la populația totală','rata de fatalitate raportează decesele la numărul de cazuri','incidența raportează cazurile existente la populația totală','rata de fatalitate raportează decesele la populația totală'],'ABC',334,'Biostatistică — Rate de morbiditate',
 'Diferențierea incidenței, prevalenței și ratei de fatalitate.',
 ['Incidența: cazuri noi / populația totală la risc.','Prevalența: cazuri existente / populația totală.','Fatalitatea: decese / numărul de cazuri din perioadă.','Descrie prevalența.','Numitorul este numărul de cazuri.']],
...
q('epidemio-adv-004',['Riscul relativ:',
 ['se determină prin studii de cohortă','peste 1 sugerează o relație pozitivă','egal cu 1 nu sugerează nicio relație','se determină prin studii caz-control','sub 1 sugerează o relație pozitivă'],'ABC',335,'Riscul bolii — Riscul relativ',
 'Interpretarea riscului relativ.',
 ['Riscul relativ se determină prin studii de cohortă.','RR >1 sugerează o relație pozitivă.','RR = 1 nu sugerează nicio relație.','Caz-controlul oferă raportul cotelor.','RR <1 sugerează o relație negativă.']],
...
q('epidemio-adv-009',['Pentru a fi considerat competent, un pacient trebuie:',
 ['să nu aibă psihoză sau intoxicație curentă','să își înțeleagă situația medicală','să decidă în acord cu valorile sale anterioare','să aibă acordul familiei','să nu își schimbe decizia după acceptarea terapiei'],'ABC',337,'Etică — Competența',
 'Aplicarea criteriilor de competență.',
 ['Nu trebuie să aibă psihoză sau intoxicație curentă.','Trebuie să își înțeleagă situația.','Trebuie să decidă în acord cu valorile anterioare.','Acordul familiei nu este criteriu.','Pacientul competent se poate răzgândi oricând.']],
